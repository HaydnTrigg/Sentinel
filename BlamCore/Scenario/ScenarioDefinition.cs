...
namespace Blam.Scenario
{
    ...
    public class ScenarioDefinition
    {
        ...
        public class ObjectName
        {
            ...
            public GameObject.ObjectTypeValueOld ObjectTypeOld;
            [MinVersion(GameVersion.V11_1_498295_Live)]
            public GameObject.ObjectTypeValueNew ObjectTypeNew;
            public byte Padding; // FIXME: This technically isn't padding and object type is a short here!
            public short PlacementIndex;
        }

        [TagDefinition(Size = 0xB8)]
