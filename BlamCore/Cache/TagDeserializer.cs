...
namespace Blam.Cache
{
    ...
    public class TagDeserializer
	{
		...
		public TagDeserializer(GameVersion version)
		{
			_version = version;
		}
		...
		{
			var info = new TagDefinition(structureType, _version);
		...
		private object DeserializeStruct(BinaryReader reader, ISerializationContext context, TagDefinition info)
		{
		...
		private object DeserializeComplexValue(BinaryReader reader, ISerializationContext context, TagFieldAttribute valueInfo, Type valueType)
		{
			...
			return DeserializeStruct(reader, context, new TagDefinition(valueType, _version));
		}
