...
namespace Blam.Cache
{
    ...
    public class TagSerializationContext : ISerializationContext
	{
		...
		private readonly StringIDsCache _stringIds;
		...
		public TagSerializationContext(Stream stream, TagCache cache, StringIDsCache stringIds, TagInstance tag)
		{
			_stream = stream;
			_cache = cache;
		...
		public void BeginSerialize(TagDefinition info)
		{
			_dataFixups.Clear();
		...
		public BinaryReader BeginDeserialize(TagDefinition info)
		{
		...
		public void EndDeserialize(TagDefinition info, object obj)
		{
		}
