...
{
    [TagDefinition(Name = "chud_globals_definition", Group = "chgd", Size = 0x2C0)]
	public class ChudGlobalsDefinition
	{
		...
		public class HudGlobal
		{
			...
			[TagDefinition(Size = 0x14, MaxVersion = GameVersion.V10_1_449175_Live)]
			[TagDefinition(Size = 0x18, MinVersion = GameVersion.V11_1_498295_Live)]
			public class HudSound
			{
				public uint LatchedTo;
				[MinVersion(GameVersion.V11_1_498295_Live)] public uint LatchedTo2;
				public float Scale;
				public List<UnknownBlock> Unknown;
